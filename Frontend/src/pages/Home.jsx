...
import running from '../assets/homePageImage/running.png';
      ...
      <section className="py-12 px-4 text-center">
        ...
        <div className="flex flex-wrap justify-center">
          <div className="w-1/3 p-4">
            <img src={happybaby} alt="Icon 1" className="mx-auto mb-4 shadow-lg w-100 h-100 object-cover" />
            <h3 className="text-2xl font-bold mb-2">Improved Mood</h3>
            <p>Exercise boosts your mood and overall mental health.</p>
          </div>
          <div className="w-1/3 p-4">
            <img src={energy} alt="Icon 2" className="mx-auto mb-4 shadow-lg w-100 h-100 object-cover" />
            <h3 className="text-2xl font-bold mb-2">Increased Energy</h3>
            <p>Regular physical activity increases your energy levels.</p>
          </div>
          <div className="w-1/3 p-4">
            <img src={sleep} alt="Icon 3" className="mx-auto mb-4 shadow-lg w-100 h-100 object-cover" />
      ...
      <section className="py-12 px-4 text-center bg-gray-100">
        ...
        <div className="flex flex-wrap justify-center">
          <div className="w-full md:w-1/3 p-4">
            <img src={running} alt="Testimonial 1" className="rounded-full w-24 h-24 mx-auto mb-4" />
          ...
          <div className="w-full md:w-1/3 p-4">
            <img src={running} alt="Testimonial 2" className="rounded-full w-24 h-24 mx-auto mb-4" />
            <p className="italic mb-2">"I love the variety of workouts and the supportive community."</p>
            <p className="font-bold">- Jamie Lee</p>
          </div>
          <div className="w-full md:w-1/3 p-4">
            <img src={running} alt="Testimonial 3" className="rounded-full w-24 h-24 mx-auto mb-4" />
